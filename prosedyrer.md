...
* Utviklingsteam (Eilev Hagen, Kasper Røstvold med flere)
* NHN kundesenter
* Superbruker
* Brukere
...
* Gi tilgang til superbruker i FALK, superbruker tar seg av videre tilganger for databasen. **Vær nøye på å gi riktige tilganger, KRITISK punkt.** 
  * Databaseansvarlig: https://falk.eforsk.nhn.no/u/app-admin/4  finn superbrukeren, trykk på den, og "gi ny tilgang" på **riktig** database
